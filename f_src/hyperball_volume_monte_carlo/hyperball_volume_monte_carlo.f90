...
!
  ...
  write ( *, '(a)' ) '  Use a Monte Carlo approach to estimate the volume of'
...
!
    ...
    call hyperball01_indicator ( dim_num, n_more, x, fx )
...
!
!    Input, integer ( kind = 4 ) POINT_NUM, the number of points to evaluate.
!
