...
!    Input, integer ( kind = 4 ) TEST, the index of the test problem
!
!    Input, integer ( kind = 4 ) BOUNDARY_EDGE_NUM, the number of 
!    boundary edges.
!
...
!    Input, integer ( kind = 4 ) TEST, the index of the test problem
!
!    Output, integer ( kind = 4 ) BOUNDARY_FACE_NUM, the number of 
!    boundary faces.
!
  implicit none
...
!    Input, integer ( kind = 4 ) TEST, the index of the test problem
!
!    Input, integer ( kind = 4 ) BOUNDARY_FACE_NUM, the number of
!    boundary faces.
!
...
!    Input, integer ( kind = 4 ) TEST, the index of the test problem
!
!    Input, integer ( kind = 4 ) BOUNDARY_NODE_NUM, the number of 
!    boundary nodes.
!
