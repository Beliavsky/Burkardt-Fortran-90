...
!
  ...
  write ( *, '(a)' ) '|  Exercise 28                                |'
  write ( *, '(a)' ) '|                                             |'
  write ( *, '(a)' ) '|  f(x,y)= 333.75 y^6                         |'
  write ( *, '(a)' ) '|    + x^2 (11x^2y^2-y^6-121y^4-2)            |'
  write ( *, '(a)' ) '|    + 5.5y^8 + x/2/y                         |'
  write ( *, '(a)' ) '|                                             |'
  write ( *, '(a)' ) '|  Evaluate f(x,y) at:                        |'
  write ( *, '(a)' ) '|                                             |'
  write ( *, '(a)' ) '|    x = 77617, y = 33096.                    |'
  write ( *, '(a)' ) '|                                             |'
  write ( *, '(a)' ) '|  The correct answer:                        |'
  write ( *, '(a)' ) '|                                             |'
  write ( *, '(a)' ) '|    f(77617,33096) = -0.827...               |'
  write ( *, '(a)' ) '|                                             |'
  write ( *, '(a)' ) '+=============================================+'
  write ( *, '(a)' ) ' '
  ...
  ys = 33096E+00
  fs = 333.75E+00 * ys**6 &
    + xs**2 * ( 11E+00 * xs**2 * ys**2 - ys**6 - 121E+00 * ys**4 - 2.0E+00 ) &
    + 5.5E+00 * ys**8 + xs / 2.0E+00 / ys 

  xd = 77617D+00
  yd = 33096D+00
  fd = 333.75D+00 * yd**6 &
    + xd**2 * ( 11D+00 * xd**2 * yd**2 - yd**6 - 121D+00 * yd**4 - 2.0D+00 ) &
    + 5.5D+00 * yd**8 + xd / 2.0D+00 / yd 

  f = - 0.827E+00

  write ( *, '(a)' ) ''
  write ( *, '(a,g14.6)' ) '  Single precision result      = ', fs
  write ( *, '(a,g14.6)' ) '  Double precision result      = ', fd
  write ( *, '(a,g14.6)' ) '  Correct result (to 3 digits) = ', f
