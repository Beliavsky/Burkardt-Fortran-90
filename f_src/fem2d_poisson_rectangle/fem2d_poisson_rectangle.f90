...
!    ELEMENT_NODE(I,J) is the global index of local node I in element J.
!
!    Input, integer ( kind = 4 ) NQ, the number of quadrature points used 
!    in assembly.
!
...
!    ELEMENT_NODE(I,J) is the global index of local node I in element J.
!
!    Input, integer ( kind = 4 ) INDX(NODE_NUM), the index of the unknown
...
!    one element.
!
!    Input, integer ( kind = 4 ) NQE, the number of points in the quadrature
...
!    Input, integer ( kind = 4 ) NODE_NUM, the number of nodes.
!
!    Output, integer ( kind = 4 ) INDX(NODE_NUM), the index of the unknown
...
!    Input, real ( kind = 8 ) F(NUNK), the coefficients of the solution.
!
!    Input, integer ( kind = 4 ) INDX(NODE_NUM), gives the index of the unknown
!    quantity associated with the given node.
!
!    Input, integer ( kind = 4 ) NODE_NUM, the number of nodes.
!
