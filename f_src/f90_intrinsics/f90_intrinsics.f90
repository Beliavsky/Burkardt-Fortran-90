...
!
  ...
  write ( *, '(a)' ) '  SET_EXPONENT(X,I) is a FORTRAN90 function which returns'
  write ( *, '(a)' ) '  the FRACTION(X)*RADIX**I, where FRACTION(X) is the '
...
!  Discussion:
!
!    The FORTRAN90 function SUM ( A, DIM=I ) returns the sum of the entries of 
!    a complex, integer, or real array along dimension I.
!
!  Licensing:
!
!    This code is distributed under the GNU LGPL license. 
