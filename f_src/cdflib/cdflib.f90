...
!  Input:
!
!    integer ( kind = 4 ) MU, part of the argument.
!
!    real ( kind = 8 ) X, part of the argument.
!
!  Output:
!
!    real ( kind = 8 ) ESUM, the value of exp ( MU + X ).
!
  implicit none
...
!  Input:
!
!    real ( kind = 8 ) A(0:N), coefficients of the polynomial.
!
!    integer ( kind = 4 ) N, length of A.
!
!    real ( kind = 8 ) X, the point at which the polynomial
!    is to be evaluated.
!
!  Output:
!
!    real ( kind = 8 ) EVAL_POL, the value of the polynomial at X.
!
  implicit none
