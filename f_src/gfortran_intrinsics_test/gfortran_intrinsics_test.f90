...
!*****************************************************************************80
!
!! MAIN is the main program for gfortran_intrinsics_test.
!
!  Discussion:
!
!    gfortran_intrinsics_test calls some of the GFORTRAN intrinsic routines.
!
!  Licensing:
!
...
!
  ...
  write ( *, '(a)' ) ' '
  write ( *, '(a)' ) 'gfortran_intrinsics_test'
...
!
  ...
  name = 'gfortran_intrinsics_test_prb.f90'
  mode = ' '
  result = access ( name, mode )
  write ( *, '(2x,a27,2x,a5,2x,i8)' ) name, '''' // mode // '''', result
